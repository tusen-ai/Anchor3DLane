...
pc_range = (-30, -0.64, -2, 30, 74.88, 4.0)
...
model = dict(
    ...
    scatter=dict(type="PointPillarsScatter", ds_factor=1),
    lidar_neck=dict(
        type="RPN",
        layer_nums=[2, 2, 3],
    ...
    voxel_size = voxel_size,
    grid_shape=(188, 236, 1),
    use_voxel=False,
    pc_range = pc_range,
    anchor_feat_channels = 64,
    lidar_dims = [128, 128, 128],
    sample_feat_lidar = [0, 1, 2],
    drop_out=0.,
    num_heads = 2,
    dim_feedforward = 128,
    pre_norm = False,
...
work_dir = 'output/openlane/anchor3dlane++_r50x2_pp'