...
import torch
from mmseg.models.utils import get_paddings_indicator
...
class PointPillarsScatter(nn.Module):
    ...
    def forward(self, voxel_features, coords, batch_size, input_shape):
        ...
        for batch_itt in range(batch_size):
            ...
            canvas = voxel_features[0].new_zeros((self.nchannels, self.nx * self.ny))

            # Only include non-empty pillars
            # nx * y + x
            indices = coords[batch_itt][:, 1] * self.nx + coords[batch_itt][:, 2]
